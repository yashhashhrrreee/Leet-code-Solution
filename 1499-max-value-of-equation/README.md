<h2><a href="https://leetcode.com/problems/max-value-of-equation/">1499. Max Value of Equation</a></h2><h3>Hard</h3><hr><div data-read-aloud-multi-block="true"><p>You are given an array <code>points</code> containing the coordinates of points on a 2D plane, sorted by the x-values, where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> such that <code>x<sub>i</sub> &lt; x<sub>j</sub></code> for all <code>1 &lt;= i &lt; j &lt;= points.length</code>. You are also given an integer <code>k</code>.</p>
