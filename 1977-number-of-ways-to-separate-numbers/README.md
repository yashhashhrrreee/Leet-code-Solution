<h2><a href="https://leetcode.com/problems/number-of-ways-to-separate-numbers/">1977. Number of Ways to Separate Numbers</a></h2><h3>Hard</h3><hr><div data-read-aloud-multi-block="true"><p>You wrote down many <strong>positive</strong> integers in a string called <code>num</code>. However, you realized that you forgot to add commas to seperate the different numbers. You remember that the list of integers was <strong>non-decreasing</strong> and that <strong>no</strong> integer had leading zeros.</p>
